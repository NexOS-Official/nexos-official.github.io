...
class UVServiceWorker extends EventEmitter {     
    ...
    async fetch({ request }) {
        ...
        try {
            ...
            ultraviolet.meta.base = ultraviolet.meta.url = new URL(this.getCachedSourceUrl(request.url));
            ...
            if (request.referrer && request.referrer.startsWith(location.origin)) {
                const referer = new URL(this.getCachedSourceUrl(request.referrer));
